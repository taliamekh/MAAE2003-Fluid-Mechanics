...
CHAPTER_ORDER = [
    ...
    "ch6-lec1", "ch6-lec2", "ch6-lec3", "ch6-prob",
    "formulas", "m2sheet", "finalsheet", "m1prep", "m2prep", "m2prep-concepts", "m2prep-sample", "m2prep-predicted", "final", "final-concepts", "final-sample", "final-predicted",
    "lab1", "lab2", "lab3",
    "summary", "progress",
]
